          ...
          <form className="app__signup">
            <center>
              <img 
                ...
                height="40px;"
                src="https://i.ibb.co/sv6kqC4/insta.png"
                alt=""
              />
            </center>
          ...
          <div>
            ...
            <div className="footer__icons">
              <div className="footer__left">
                <img onClick={home} className="app__home" src="https://img.icons8.com/ios-filled/2x/home.png" alt='home icon to go back up'/>         
              </div>

              <div className="footer__middle">
                <img onClick={() => setOpenImageUpload(true)} className="app__add-postImg" src="https://img.icons8.com/ios-filled/2x/plus.png" alt='plus icon to add posts'/>
              </div>
